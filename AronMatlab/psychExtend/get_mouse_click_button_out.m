function [click_x, click_y, wait_time, button1_press,button2_press,button3_press] = get_mouse_click_button_out(screen_pointer, max_wait_in_secs, target_area, wait_if_already_down)
%
