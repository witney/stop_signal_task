function [click_x, click_y, wait_time, button1_press,button2_press,button3_press] = get_mouse_click_button_out_nicki(screen_pointer, max_wait_in_secs, target_area, wait_if_already_down)
%
...
%% wait for mouse response
    ...
    wait_time = GetSecs;
    button1_press = buttons(1,1);
    button2_press = buttons(1,2);
    button3_press = buttons(1,3);
%% return results
