...
%% initialization
    switch command
        case {'initialize', 'init', ''}
            ...
            exp.was_properly_initialized = true;

            % configure both ports for output
            DaqDConfigPort(exp.daq_id, port_a, config_for_ouput);
            DaqDConfigPort(exp.daq_id, port_b, config_for_ouput);
